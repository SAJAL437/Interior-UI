      ...
      <div className="container mx-auto w-full">
        ...
        <div className="flex flex-col items-center w-full mt-24 px-4 text-center">
          ...
          <p className="max-w-3xl text-base md:text-lg mb-10 text-left">
            Collaborate with top designers to get personalized plans tailored to
            your space and taste — all from the comfort of your home.
          </p>
          <img
        ...
        <div className="flex flex-col md:flex-row justify-center items-center w-full mt-24 gap-10">
          <div className="w-full md:w-1/2 px-2 sm:px-4">
            ...
            <p className="text-base md:text-lg text-justify">
              ...
              concierge service ensures the best deals with exclusive discounts
        ...
        <div className="flex flex-col md:flex-row justify-center items-center w-full mt-24 gap-10">
          ...
          <div className="w-full text-center">
            <div className="w-full h-[7rem] mx-auto border-t-2 border-l-2 border-r-2 rounded-3xl p-3 relative">
              <p className="text-sm absolute -top-3 left-1/2 -translate-x-1/2 w-fit bg-white px-2">
                {/* <FontAwesomeIcon icon={faCalendar} /> */}
              </p>
              <p className="text-xl md:text-lg text-gray-900 font-serif">
                Realistic 3D model & top professional help to take the guesswork
                out of the designing process.
              </p>
            </div>
          </div>
